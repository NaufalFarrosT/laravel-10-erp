                                    ...
                                    <tr id="tr_{{ $category->id }}">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary" id="btnShow"
                                                onclick="showAllItemBasedOnCategory({{ $category->id }})"><i
