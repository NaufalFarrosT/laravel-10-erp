        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input class="form-control form-control-inline input-medium date-picker col-sm-6" size="16"
                    type="date" value="{{ $purchase_payment->date }}" id="eDatePicker" name="eDatePicker" />
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ePayment_amount" name="ePayment_amount"
                    value="{{ 'Rp. ' . number_format($purchase_payment->amount, 0, ',', '.') }}"
                ...
                <div class="">
                    <select class="custom-select" id="eAccount_id" name="eAccount_id">
                        @foreach ($sub_accounts as $account)
                            @if ($account->id == $purchase_payment->sub_account_id)
...
<div class="modal-footer justify-content-between">
    <button type="button" class="btn btn-primary" data-dismiss="modal"
        onclick="updatePaymentData({{ $purchase_payment->id }})">Ubah</button>
